...
3. Start app
   ...
   npm start
   ```
4.  Clone/Open and run server code [Server](github.com/devdevvy/myops-server)
...
Randall Thomas - randallthomasmusic@gmail.com

Project Link: [https://github.com/devdevvy/myops-client](https://github.com/devdevvy/myops-client)
